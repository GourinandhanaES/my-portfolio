...
const Nav = () => {
  ...
  return (
    <nav className='flex flex-col bg-red-500/30 p-20 items-center xl:items-center gap-y-4 fixed h-max  bottom-0 mt-auto xl:right-[2%] z-50 top-0 w-full xl:w-16  xl:max-w-md '>
    {/* inner */}
